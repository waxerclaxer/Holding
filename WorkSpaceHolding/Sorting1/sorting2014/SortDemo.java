...
public class SortDemo {
	...
	public String testAll(String filename) {
		String sortTypes[] = { "RadixSort",  "SelectionSort", "BubbleSort", 
				"OpBubbleSort", "QuickSort","MergeSort", };
	...
	public static void main(String[] args) {                                    //-XX:CompileThreshold=0
		...
		//long startTime = System.currentTimeMillis();
		                                    ...
		                                    //test all 
//	System.out.println(sd.testAll("test6b.dat"));
	
		
		                                   //test Everything  to run all test. maybe remove forst result 
	//	System.out.println(sd.testEverything());
		
		//test one would be ran like this to test the speed of the JVM
